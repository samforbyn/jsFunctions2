...
// CODE HERE
const wSalesTax = orders.map(function(num){
  realTax = num.price * num.tax
  return realTax + num.price
})

console.log(wSalesTax)
...
// const allBobs = purchases.filter(function(element){
// return element.owner === "Bob"
// })
                                                              //<<< DECLARATIONS 
// const bobsTotal = allBobs.reduce(function(acc, curr){
...
const myBob = purchases.filter(ele => ele.owner === "Bob").reduce((acc, curr)=> acc + curr.price ,0)
console.log(myBob)